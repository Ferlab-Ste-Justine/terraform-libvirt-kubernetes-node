...
module "nfs_client_configs" {
  source = "git::https://github.com/Ferlab-Ste-Justine/terraform-cloudinit-templates.git//nfs-client?ref=v0.46.3"
...
module "kubernetes_node_configs" {
  source                      = "git::https://github.com/Ferlab-Ste-Justine/terraform-cloudinit-templates.git//kubernetes-node?ref=v0.46.3"
  install_dependencies        = var.install_dependencies
